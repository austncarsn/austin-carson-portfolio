...
export const GALLERY_PROJECTS: GalleryProject[] = [
  ...
  },
  {
    ...
    challenge:
      'Premium collectibles required clear presentation without visual clutter or overwhelming detail. Traditional e-commerce sites had friction in the checkout flow, reducing conversion rates. The challenge was to create subtle feedback during interactions without distracting animations while maintaining a premium aesthetic across all devices.',
    solution:
      'We adopted a card-first product layout with generous whitespace (40px+ margins) and clear typographic hierarchy. Designed concise, contextual micro-interactions for add-to-cart and checkout using Framer Motion. Prioritized a restrained visual language with neutral colors and minimal decorative elements, implementing responsive patterns to maintain premium feel.',
    results: [
  ...
  },
  {
    ...
    solution:
      'We built an interactive web app that lets users generate palettes, test contrast against common UI surfaces, and export tokens in CSS/JSON. The UI emphasizes rapid iteration with meaningful defaults and accessible presets.',
    results: [
