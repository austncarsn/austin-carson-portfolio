        ...
        <FadeInSection delay={100} direction="left">
          <div className="flex min-h-0 flex-col self-start space-y-5">
            <a
              ...
              className="group inline-flex w-full items-center gap-4 px-8 py-6 bg-canvas text-text-primary border-2 border-structure rounded-md transition-transform duration-200 ease-out hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-hover)] focus-visible:ring-offset-2"
            ...
            <a
              ...
              className="group inline-flex w-full items-center gap-4 px-8 py-6 bg-canvas border-2 border-structure text-text-primary rounded-md transition-transform duration-200 ease-out hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-hover)] focus-visible:ring-offset-2"
            >
