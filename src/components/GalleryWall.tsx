  ...
  return (
    <section aria-labelledby="gallery-wall" className="space-y-4">
      ...
      <div className="relative">
        <div className="pointer-events-none absolute inset-y-0 left-0 w-12 [mask-image:linear-gradient(to_right,black,transparent)] bg-[var(--gallery-surface,#fffceb)]" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-12 [mask-image:linear-gradient(to_left,black,transparent)] bg-[var(--gallery-surface,#fffceb)]" />
