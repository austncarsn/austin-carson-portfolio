...
const SectionHeader = ({ title }: { title: string }): React.JSX.Element => (
  <h2 className="text-xs uppercase tracking-wider mb-4 font-semibold text-neutral-900 border-b-2 border-accent pb-2">
    {title}
  </h2>
);
    ...
    () => [
      {
        ...
        techStack:
          'Tech Stack: React, Next.js, TypeScript, Tailwind CSS, Figma, Git, Canvas API, SVG Optimization',
      },
      {
        ...
        <div className="mx-auto max-w-[8.5in] bg-surface rounded-xl border border-line p-8 md:p-12 shadow-lg">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-neutral-600">
              ...
              <a
                className="text-accent hover:underline"
                href="https://linkedin.com/in/austin-carson"
                target="_blank"
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-neutral-700 leading-relaxed">
              Product designer and front-end developer specializing in design systems,
              component architecture, and user-centered interfaces. Expertise spans
              Figma-to-code workflows, React development, and systematic design thinking.
              Creates cohesive digital experiences through thoughtful interaction design,
              accessible components, and performance-optimized front-end implementation.
              Bridges design and engineering to deliver polished, scalable products.
            </p>
          </section>
          ...
          <div className="text-center mt-10 print:hidden border-t border-line pt-8">
            <p className="text-sm text-neutral-600 mb-4">
              To save as PDF: Press <strong>Cmd+P</strong> → Choose "Save as PDF" → Click
              Save.
            </p>
            <Button
